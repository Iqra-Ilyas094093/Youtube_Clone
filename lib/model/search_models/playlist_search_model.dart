...
class PlaylistSearchModel {
  ...
  factory PlaylistSearchModel.fromRawJson(String str) => PlaylistSearchModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory PlaylistSearchModel.fromJson(Map<String, dynamic> json) => PlaylistSearchModel(
    kind: json["kind"],
    etag: json["etag"],
