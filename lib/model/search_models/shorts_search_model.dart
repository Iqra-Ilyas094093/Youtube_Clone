...
class ShortsSearchModel {
  ...
  factory ShortsSearchModel.fromRawJson(String str) => ShortsSearchModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ShortsSearchModel.fromJson(Map<String, dynamic> json) => ShortsSearchModel(
    kind: json["kind"],
    etag: json["etag"],
